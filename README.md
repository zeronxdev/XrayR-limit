...
![](https://img.shields.io/github/stars/zeronxdev/XrayR-limit)
![](https://img.shields.io/github/forks/zeronxdev/XrayR-limit)
![](https://github.com/zeronxdev/XrayR-limit/actions/workflows/release.yml/badge.svg)
![](https://github.com/zeronxdev/XrayR-limit/actions/workflows/docker.yml/badge.svg)
[![Github All Releases](https://img.shields.io/github/downloads/zeronxdev/XrayR-limit/total.svg)]()

[Iranian(farsi) README](https://github.com/zeronxdev/XrayR-limit/blob/master/README_Fa.md), [Vietnamese(vi) README](https://github.com/zeronxdev/XrayR-limit/blob/master/README-vi.md), [English(en) README](https://github.com/zeronxdev/XrayR-limit/blob/master/README-en.md)
...
```
wget -N https://raw.githubusercontent.com/zeronxdev/XrayR-limit-release/master/install.sh && bash install.sh
```
...
[Mozilla Public License Version 2.0](https://github.com/zeronxdev/XrayR-limit/blob/master/LICENSE)
...
[![Stargazers over time](https://starchart.cc/zeronxdev/XrayR-limit.svg)](https://starchart.cc/zeronxdev/XrayR-limit)
